    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        Context = new(
            ...
            createFunc: async contract =>
            {
                ...
                await _client.CreateContractEndpointAsync("1", contract.Adapt<CreateContractCommand>());
            ...
            updateFunc: async (id, contract) =>
            {
                ...
                await _client.UpdateContractEndpointAsync("1", id, contract.Adapt<UpdateContractCommand>());
