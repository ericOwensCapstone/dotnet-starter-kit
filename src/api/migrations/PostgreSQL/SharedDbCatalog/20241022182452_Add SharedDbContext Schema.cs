        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetAdfi = table.Column<double>(type: "double precision", nullable: false),
                    AdfiStdDev = table.Column<double>(type: "double precision", nullable: false),
                    TargetWeightRangeForSort = table.Column<double>(type: "double precision", nullable: false),
                    MergeableDuration = table.Column<int>(type: "integer", nullable: false),
                    MergeableWeightRange = table.Column<double>(type: "double precision", nullable: false),
                    MaxHead = table.Column<int>(type: "integer", nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uuid", nullable: true)
