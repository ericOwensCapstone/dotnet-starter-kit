...
using FSH.Starter.WebApi.Ranch.Application.LifecycleStages.Search.v1;
using MediatR;
...
namespace FSH.Starter.WebApi.Ranch.Infrastructure.Endpoints.v1.LifecycleStages;
...
public static class SearchLifecycleStagesEndpoint
{
    ...
    {
        return endpoints
            .MapPost("/search", async (ISender mediator, [FromBody] SearchLifecycleStagesCommand command) =>
            {
